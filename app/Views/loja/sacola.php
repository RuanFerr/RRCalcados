                            ...
                            <tr class="shipping_area">
                                ...
                                <td>
                                    <div class="shipping_box">
                                        <ul class="list">
                                            <li><a href="#">Correios</a></li>
                                        </ul>
                                        <h6>Calcule o frete<i class="fa fa-caret-down" aria-hidden="true"></i></h6>
                                        <select class="shipping_select">
                                            <option value="1">Selecione sua região</option>
                                            <option value="2">Ceará</option>
                                        </select>
                                        <input type="text" placeholder="Postcode/Zipcode">
                                        <a class="gray_btn" href="#">Calcular</a>
                                    </div>
                                </td>
                            </tr>
                            <tr class="out_button_area">
                                ...
                                <td>
                                    <div class="checkout_btn_inner d-flex align-items-center">
                                        <a class="gray_btn" href="index.html">Continue Comprando</a>
                                        <a class="primary-btn" href="endereco-envio.html">Endereço para envio</a>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
				...
				<div class="col-lg-2 col-md-6 col-sm-6">
					<div class="single-footer-widget">
						...
						<div class="footer-social d-flex align-items-center">
						 ...
						 <a href="https://www.instagram.com/_rrcalcados_/"><i class="fa fa-instagram"></i></a> 
						</div>
					</div>
				</div>
			</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos os direitos reservados para <i class="fa fa-heart-o" aria-hidden="true"></i>  <a href="https://www.rrcalcados.com.br target="_blank>RR Calçados</a>
</p>
			</div>
		</div>
	</footer>
