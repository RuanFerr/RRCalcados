		...
		<div class="row">
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				<div class="filter-bar d-flex flex-wrap align-items-center">
					<div class="sorting">
						<button type="submit" value="submit" class="primary-btn"><a
								href="cadastrar-produtos.html">cadastrar</a></button>
					</div>
					<div class="sorting mr-auto">
						<button type="submit" value="submit" class="primary-btn"><a
								href="listar-produtos-cadastrados.html">cadastrados</a></button>
					</div>
				</div>
										...
										<div class="col-md-12 form-group p_star">
											<form>
												<div class="form-group">
													<br>
													<img src="img/bootstrap-icons-1.0.0/arrow-up.svg" alt=""height="52" widht="52">
													<br>
													<h5><a>Para acessar essa funcionalidade escolha um dos botões na barra acima. </a></h5>
												</div>
											</form>
										</div>
									</form>
		...
		<div class="container">
			...
			<div class="footer-bottom d-flex justify-content-center align-items-center flex-wrap">
				<p class="footer-text m-0">
					Copyright &copy;
					<script>document.write(new Date().getFullYear());</script> Todos os direitos reservados para <i
						class="fa fa-heart-o" aria-hidden="true"></i> de <a href="https://www.rrcalcados.com.br target="
						_blank">RR Calçados</a>
				</p>
			</div>
		</div>
	</footer>
