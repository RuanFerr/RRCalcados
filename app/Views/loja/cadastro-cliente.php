        ...
        <div class="col-lg-12">
            ...
            <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                ...
                <div class="col-md-12 form-group">
                    <input type="text" class="form-control" id="company" name="company" placeholder="Sobrenome">
				</div>
				...
				<div class="col-md-6 form-group p_star">
					<input type="text" class="form-control" id="date" name="data-de-nascimento">
              ...
              <div>
				  <br>
                <a class="primary-btn" href="aviso-confirmacao-cadastro.html">Criar Conta </a>
             </div>
            </form>
        </div>
