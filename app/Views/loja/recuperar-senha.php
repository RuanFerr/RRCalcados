				...
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<p>Clique aqui para realizar login. </p>
							<a class="primary-btn" href="login.html">Entrar em conta</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="mensagem-verificar-clientel.html" method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group">
								<button  type="submit" value="submit" class="primary-btn">Recuperar</button>
							</div>
						</form>
					</div>
				</div>
