					...
					<ul class="main-categories">
						...
						<li>
							<img src="img/bootstrap-icons-1.0.0/truck.svg" alt="" width="32" height="32"
								title="Bootstrap">
							<a href="verificar-pedidos-enviados.html">Verificar pedidos para envio</a>
						</li>
						<br>
						<li>
										...
										<div class="col-md-12 form-group p_star">
											<form>
												<div class="form-group">
													<h5><a>Para acessar essa funcionalidade digite na barra o numero de identificação do calçado desejado  </a></h5>
                                                    <br>
												<div class="col-md-12 form-group">
													<input type="text" class="form-control" id="calcado" name="calcado" placeholder="Buscar calçado">
                                                 </div>
                                                    <br>
													<div>
														<br>
													  <a class="primary-btn" href="listar-buscar-calcado-adm.html">selecionar</a>
												   </div>
												</div>
											</form>
										</div>
